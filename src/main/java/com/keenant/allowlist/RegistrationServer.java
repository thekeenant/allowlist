...
public class RegistrationServer implements Handler {
  ...
  private final Cache<String, Boolean> recentlyRegisteredVerificationCodes = CacheBuilder
      .newBuilder()
  ...
  public void handle(Context context) {
    ...
    recentlyRegisteredVerificationCodes
        .put(body.get(VERIFICATION_CODE_JSON_KEY).getAsString(), true);
    context.result("OK");
  }
